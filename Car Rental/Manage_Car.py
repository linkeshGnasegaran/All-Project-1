...
# Function to go back to Admin_Panel
def go_back():
    window.destroy()  # Close the current window
    os.system('python Admin_Panel.py')  # Open Admin_Panel.py
...
# Create the back button at the top right corner
back_button = Button(
    window,
    text="Back",
    command=go_back,
    bg="sky blue",  # Light background for the button
    fg="black",  # Black text
    font=("Arial", 12),
    relief="raised",  # flat, groove, raised, ridge, solid, or sunken
    width=8
)
back_button.place(x=1190, y=20)  # Place it at the top right corner
